      ...
      <div className="rounded-2xl border border-gray-100 bg-linear-to-br from-amber-50/60 via-white to-gray-50 p-6 shadow-sm">
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="relative shrink-0">
            ...
            {/* "Expert" badge */}
            <span className="absolute -bottom-1 -right-1 rounded-full border-2 border-white bg-brand-primary px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wide text-white shadow">
              Expert
            </span>
          </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mb-0.5 flex flex-wrap items-center gap-2">
              <p className="text-[15px] font-black text-gray-900">{name}</p>
              <span className="rounded-full bg-brand-primary/10 px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest text-brand-primary">
                Viora Wine
              </span>
            </div>

            {/* Title */}
            <p className="mb-2 text-[12px] font-semibold text-gray-400 uppercase tracking-wide">
              {title}
            </p>
