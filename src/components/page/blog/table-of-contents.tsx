				...
				<li key={id} className={level === 3 ? "pl-4" : ""}>
					<a
						...
						className={[
							...
							level === 2 ? "text-[13px] font-semibold" : "text-[12px] font-normal",
							activeId === id
...
export default function TableOfContents({ headings, tocTitle, mode }: TableOfContentsProps) {
	...
	const MobilePanel = (
		<div className="mb-6 overflow-hidden rounded-xl border border-gray-200 bg-white">
			<button
				...
				className="flex w-full items-center justify-between px-4 py-3 text-[13px] font-bold text-gray-700"
			...
			{isOpen && (
				<nav id="toc-mobile-list" className="border-t border-gray-100 px-3 pt-2 pb-3">
