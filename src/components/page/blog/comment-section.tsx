    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <input
            ...
            autoComplete="name"
            className={`w-full rounded-xl border px-4 py-2.5 text-[13px] outline-none transition focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20 ${
      ...
      <div>
        ...
        <textarea
          ...
          className={`w-full resize-none rounded-xl border px-4 py-3 text-[13px] leading-relaxed outline-none transition focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20 ${
            errors.body ? "border-red-400 bg-red-50" : "border-gray-200 bg-white"
          }`}
          {...field("body")}
        />
        {errors.body && (
          <p className="mt-1 text-[11px] text-red-500">{errors.body}</p>
        )}
      </div>
    ...
    <section className="border-t border-gray-100 bg-white py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex items-center gap-3">
          ...
          <h2 className="text-[18px] font-black uppercase tracking-tight text-gray-900">
            {t("title")}
          </h2>
        ...
        <div className="mb-10 rounded-2xl border border-gray-100 bg-gray-50/60 p-5 sm:p-6">
          <p className="mb-4 text-[13px] font-semibold text-gray-600">
            {t("leave_comment")}
          </p>
          ...
          <>
            ...
            {hasMore && (
              <button
                ...
                className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl border border-gray-200 py-2.5 text-[13px] font-semibold text-gray-500 transition hover:border-brand-primary hover:text-brand-primary"
              >
                <ChevronDown size={15} />
