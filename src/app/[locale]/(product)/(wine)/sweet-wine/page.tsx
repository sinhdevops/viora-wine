...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
	...
	return {
		...
		keywords: [
			...
			"Riesling ngọt",
			"Sauternes",
			"rượu vang ngọt dễ uống",
			"rượu vang cho người mới",
			"vang ngọt Đà Nẵng",
			"rượu vang ngọt chính hãng",
			"Viora Wine",
			"viorawine",
			"viora wine",
		],
			...
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: "Rượu Vang Ngọt – Viora Wine",
				},
			],
		},
		twitter: {
			card: "summary_large_image",
			title: "Rượu Vang Ngọt – Viora Wine",
			description: "Moscato, Riesling ngọt chính hãng từ 380.000đ.",
		},
	};
}
			...
			<div className="min-h-screen bg-white">
				...
				<section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
					...
					<p className="mb-8 text-gray-500">
						Toàn bộ vang ngọt nhập khẩu chính hãng — dễ uống, thơm ngon, phù hợp mọi khẩu vị.
					</p>
					...
					<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
						<div className="mx-auto max-w-3xl">
							...
							<div className="space-y-4 leading-relaxed text-gray-600">
								<p>
									<strong>Rượu vang ngọt</strong> là những loại vang có hàm lượng đường dư (residual
									sugar) cao sau quá trình lên men — thường từ 45g/L trở lên. Vị ngọt này có thể đến
									từ nhiều nguồn khác nhau: quá trình lên men bị dừng sớm, nho thu hoạch muộn (late
									harvest), hoặc nho bị ảnh hưởng bởi <strong>botrytis cinerea</strong> (nấm quý tạo
									ra Sauternes danh tiếng).
								</p>
								<p>
									<strong>Moscato d'Asti</strong> từ Ý là loại vang ngọt phổ biến nhất thế giới — sủi
									bọt nhẹ, độ cồn thấp 5–7%, hương đào, cam bergamot và hoa tươi.{" "}
									<strong>Riesling Spätlese/Auslese</strong> từ Đức mang hương khoáng chất độc đáo và
									vị ngọt cân bằng tuyệt vời. <strong>Sauternes</strong> từ Bordeaux là loại vang ngọt
									cao cấp nhất — phức tạp, hương mật ong, mơ và nghệ tây.
								</p>
								<p>
									Rượu vang ngọt là <strong>lý tưởng cho người mới bắt đầu</strong> vì vị quen thuộc
									và dễ tiếp cận. Không đắng, không chát, hương thơm rõ ràng — nhiều người khám phá
									tình yêu với rượu vang qua một chai Moscato lạnh trong buổi chiều hè.
								</p>
							</div>
						</div>
					</div>
							...
							{[
								{
									icon: "🍑",
									title: "Moscato",
									desc: "Ý — sủi bọt nhẹ, 5–7% ABV, hương đào và hoa cam. Dễ uống nhất, phù hợp người mới bắt đầu",
								},
								{
									icon: "🍋",
									title: "Riesling ngọt",
									desc: "Đức — hương khoáng chất và chanh, vị ngọt cân bằng độ chua tự nhiên. Phong phú và tinh tế",
								},
								{
									icon: "🍯",
									title: "Sauternes",
									desc: "Pháp — botrytis tạo hương mật ong, mơ, nghệ tây. Loại vang ngọt cao cấp và lâu đời nhất thế giới",
								},
								{
									icon: "🫐",
									title: "Late Harvest",
									desc: "Thu hoạch muộn — nho cô đặc đường tự nhiên, hương trái cây đậm đà, phong phú và dễ uống",
								},
							].map((item) => (
								<div
									key={item.title}
				...
				<section className="bg-[#5B3A8B] py-14 text-white">
					<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
						<h2 className="mb-4 text-center text-2xl font-semibold sm:text-3xl">
							Vang Ngọt Uống Cùng Gì Ngon Nhất?
						</h2>
						<p className="mx-auto mb-10 max-w-2xl text-center text-white/75">
							Nguyên tắc vàng: vang ngọt không được ngọt hơn món ăn — nếu không rượu sẽ trở nên nhạt nhẽo.
							Chọn vang ngọt cân bằng hoặc đi với món mặn để tạo tương phản thú vị.
						</p>
						<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
							{[
								{
									dish: "🍰 Bánh mousse / Panna cotta",
									note: "Moscato sủi bọt tươi mát cân bằng độ béo của bánh ngọt nhẹ nhàng",
								},
								{
									dish: "🍓 Trái cây tươi / Sorbet",
									note: "Riesling ngọt với dâu tây tươi và sorbet — refreshing pairing mùa hè",
								},
								{
									dish: "🧀 Phô mai xanh (Roquefort)",
									note: "Sauternes & phô mai xanh mặn — tương phản ngọt-mặn tạo nên một trong những pairing huyền thoại",
								},
								{
									dish: "🦆 Foie gras / Gan ngỗng",
									note: "Sauternes với foie gras — pairing truyền thống Pháp, béo ngậy và ngọt tương phản hoàn hảo",
								},
								{
									dish: "🍫 Chocolate đen 70%+",
									note: "Late harvest đỏ ngọt với chocolate đen đắng — tương phản tạo hương vị phức tạp bất ngờ",
								},
								{
									dish: "☕ Tráng miệng café / Tiramisu",
									note: "Moscato nhẹ không cạnh tranh với hương café, tạo cân bằng tuyệt vời",
								},
							].map((item) => (
						...
						<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
							{[
								...
								},
								{
									...
									desc: "Màu hồng quyến rũ, hương dâu tây tươi mát",
								},
							].map((item) => (
								<a
									key={item.href}
									href={item.href}
									className="group flex items-center justify-between rounded-2xl border border-gray-200 bg-gray-50 px-6 py-5 transition-all hover:border-[#9B5FC0] hover:bg-purple-50"
								>
									<div>
				...
				<section className="bg-gray-50 py-14">
					<div className="mx-auto max-w-3xl px-4 sm:px-6">
						<h2 className="mb-8 text-center text-xl font-semibold sm:text-3xl">
							Câu Hỏi Thường Gặp Về Rượu Vang Ngọt
						</h2>
					...
					<div className="mx-auto max-w-xl px-4 text-center">
						...
						<div className="flex flex-wrap justify-center gap-4">
							<a
								...
								className="rounded-lg bg-[#5B3A8B] px-8 py-3.5 font-semibold text-white transition-colors hover:bg-[#4a2d73]"
							>
