...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
	...
	return {
		...
		keywords: [
			...
			"rượu vang trắng Úc",
			"rượu vang trắng Đà Nẵng",
			"rượu vang trắng Hà Nội",
			"Viora Wine",
			"viorawine",
			"viora wine",
		],
			...
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: "Rượu Vang Trắng – Viora Wine",
				},
			],
		},
		twitter: {
			card: "summary_large_image",
			title: "Rượu Vang Trắng Nhập Khẩu – Viora Wine",
			description: "Chardonnay, Sauvignon Blanc chính hãng từ 350.000đ.",
		},
	};
}
			...
			<div className="min-h-screen bg-white">
				...
				<section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
					...
					<p className="mb-8 text-gray-500">
						Toàn bộ vang trắng nhập khẩu chính hãng — tươi mát, thanh thoát, hợp mọi khẩu vị.
					</p>
						...
						<div className="mx-auto max-w-3xl">
							...
							<div className="space-y-4 leading-relaxed text-gray-600">
								<p>
									...
									<strong>lên men không tiếp xúc vỏ</strong> — đây là điểm khác biệt cốt lõi so với
									vang đỏ. Kết quả là màu vàng rơm đến vàng xanh, hầu như không có tanin, vị tươi mát
									và độ chua thanh.
								</p>
								<p>
									Các giống nho trắng nổi tiếng nhất bao gồm <strong>Chardonnay</strong> (đầy đặn,
									hương bơ và trái cây nhiệt đới), <strong>Sauvignon Blanc</strong> (sắc nét, hương
									chanh và cỏ xanh), <strong>Riesling</strong> (hương hoa và khoáng chất độc đáo) và{" "}
									<strong>Pinot Grigio</strong> (nhẹ nhàng, dễ uống hàng ngày).
								</p>
								<p>
									Rượu vang trắng là lựa chọn lý tưởng cho bữa trưa nhẹ, tiệc ngoài trời và các dịp
									cần sự tươi mát. Đặc biệt hoàn hảo khi kết hợp với{" "}
									<strong>hải sản, gà, rau củ và phô mai tươi</strong> — những thực phẩm phổ biến
							...
							{[
								{
									icon: "🥂",
									title: "Màu sắc",
									desc: "Vàng rơm nhạt (Pinot Grigio) đến vàng vàng đậm (Chardonnay ủ gỗ). Màu phản ánh giống nho và phương pháp sản xuất",
								},
								{
									icon: "🌸",
									title: "Hương thơm",
								...
								},
								{
									icon: "👅",
									title: "Vị giác",
									desc: "Thanh mát, chua nhẹ, hầu như không có tanin. Chardonnay đầy đặn hơn, Sauvignon Blanc sắc nét hơn",
								},
								{
									icon: "🌡️",
									title: "Phục vụ",
									desc: "8–12°C — nhất thiết phải uống lạnh để giữ hương thơm tươi. Không nên uống ở nhiệt độ phòng vì mất đi sự tươi mát",
								},
							].map((item) => (
								<div
									key={item.title}
				...
				>
					<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
						...
						<p className="mx-auto mb-10 max-w-2xl text-center text-white/75">
							Độ chua thanh của vang trắng làm sáng lên hương vị hải sản và các món nhẹ — pairing hoàn hảo
							cho ẩm thực Việt Nam và Địa Trung Hải.
						</p>
						<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
							{[
								{
									dish: "🦐 Tôm hùm / Hải sản nướng",
									note: "Sauvignon Blanc tôn lên vị ngọt tự nhiên của hải sản — pairing kinh điển không thể nhầm",
								},
								{
								...
								{
									dish: "🥗 Salad / Rau củ",
									note: "Sauvignon Blanc tươi mát làm dịu vị chua của salad, hương cỏ xanh hòa quyện tuyệt vời",
								},
								{
									dish: "🍗 Gà nướng / Gà hấp",
									note: "Chardonnay đầy đặn đủ sức đi kèm thịt gà mà không lấn át",
								},
								{
									dish: "🧀 Phô mai tươi / Brie",
									note: "Riesling và Sauvignon Blanc cân bằng hoàn hảo với phô mai mềm béo ngậy",
								},
								{
									dish: "🍜 Phở gà / Bún cá",
									note: "Vang trắng nhẹ như Pinot Grigio bổ sung mà không cạnh tranh với nước dùng thanh ngọt",
								},
							].map((item) => (
						...
						<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
							{[
								...
								<a
									key={item.href}
									href={item.href}
									className="group flex items-center justify-between rounded-2xl border border-gray-200 bg-gray-50 px-6 py-5 transition-all hover:border-[#C8A951] hover:bg-amber-50"
								>
									<div>
