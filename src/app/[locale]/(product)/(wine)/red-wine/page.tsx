...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
	...
	return {
		...
		twitter: {
			...
			description: "Vang đỏ chính hãng từ 390.000đ. Giao nhanh 2–4h Đà Nẵng.",
		},
	};
}
			...
			<div className="min-h-screen bg-white">
				...
				<section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
					...
					<p className="mb-8 text-gray-500">
						Toàn bộ vang đỏ nhập khẩu chính hãng — tuyển chọn từ các vùng rượu nổi tiếng thế giới.
					</p>
						...
						<div className="mx-auto max-w-3xl">
							...
							<div className="space-y-4 leading-relaxed text-gray-600">
								<p>
									...
									<strong>Cabernet Sauvignon, Merlot, Pinot Noir, Syrah/Shiraz, Malbec</strong>. Điểm
									khác biệt lớn nhất so với vang trắng là quá trình lên men{" "}
									<strong>có tiếp xúc với vỏ nho</strong> — chính vỏ nho tạo ra màu đỏ đặc trưng,
									tanin và nhiều hợp chất polyphenol có lợi cho sức khỏe.
								</p>
								<p>
									Tanin trong rượu vang đỏ là "chữ ký" quan trọng — tạo cảm giác se miệng nhẹ nhàng và
									giúp rượu có khả năng lưu trữ lâu dài. Tanin cao hay thấp phụ thuộc vào giống nho,
									vùng trồng và phương pháp sản xuất. <strong>Cabernet Sauvignon</strong> có tanin
									mạnh và cần thời gian ủ dài, trong khi <strong>Pinot Noir</strong> và{" "}
									<strong>Merlot</strong> tanin mềm hơn, dễ uống hơn.
								</p>
								<p>
									Tại Việt Nam, rượu vang đỏ được ưa chuộng nhất nhờ vị đậm đà phù hợp với các món
									thịt nướng, lẩu và bữa tiệc. Shiraz Úc và Cabernet Sauvignon Chile là hai lựa chọn
									phổ biến nhất vì giá tốt, chất lượng ổn định và dễ tìm thấy ở mức giá
									400.000–900.000đ.
								</p>
							</div>
						</div>
							...
							{[
								{
									icon: "🍷",
									title: "Màu sắc",
									desc: "Từ đỏ ruby nhạt (Pinot Noir) đến tím đen sâu (Cabernet, Shiraz) — màu sắc phản ánh độ đậm và tuổi rượu",
								},
								{
									icon: "🌸",
									title: "Hương thơm",
									desc: "Trái cây đỏ (cherry, dâu), trái cây đen (mận, blackberry), hoa violet, vani, gỗ sồi, đôi khi có hương đất và thuốc lá",
								},
								{
									icon: "👅",
									title: "Vị giác",
									desc: "Đậm đà, tanin cân bằng, độ chua vừa phải. Vị khác nhau tùy giống nho — từ mềm mại (Merlot) đến mạnh mẽ (Cab Sauv)",
								},
								{
									icon: "🌡️",
									title: "Phục vụ",
									desc: "16–18°C là nhiệt độ lý tưởng. Decant 20–30 phút với rượu trẻ để mở hương. Bảo quản 14–18°C, tránh ánh sáng",
								},
							].map((item) => (
								<div
									key={item.title}
				...
				<section className="bg-[#6B0F1A] py-14 text-white">
					<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
						...
						<p className="mx-auto mb-10 max-w-2xl text-center text-white/75">
							Tanin trong vang đỏ tương tác với protein trong thịt, làm mềm tanin và tôn lên hương vị món
							ăn — đây là lý do vang đỏ &amp; thịt đỏ là cặp đôi kinh điển.
						</p>
						<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
							{[
								{
									dish: "🥩 Bò nướng / Steak",
									note: "Pairing kinh điển nhất — Cabernet Sauvignon hoặc Shiraz đậm đà tôn lên vị ngọt của thịt bò",
								},
								{
									dish: "🍖 Cừu quay / Sườn BBQ",
									note: "Tanin Shiraz cắt qua chất béo cừu, tạo cân bằng hoàn hảo",
								},
								{
									dish: "🫕 Bò lúc lắc / Bò hầm",
									note: "Món Việt hợp nhất với vang đỏ — sốt đậm đà hòa quyện với tanin",
								},
								{
									dish: "🧀 Phô mai cứng",
									note: "Cheddar, Manchego — tanin và béo ngậy tạo nên sự cân bằng tuyệt vời",
								},
								{
									dish: "🍝 Pasta thịt bò / Pizza",
									note: "Sangiovese Ý hoàn hảo với pasta bolognese và pizza pepperoni",
								},
								{
									dish: "🌶️ Lẩu thập cẩm / Nướng",
									note: "Vang đỏ tầm trung giúp bữa nhậu bạn bè thêm đặc biệt",
								},
							].map((item) => (
						...
						<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
							{[
								...
								},
								{
									...
									desc: "Màu hồng quyến rũ, hương dâu tây, uống mát cực ngon",
								},
								{
				...
				<section className="bg-gray-50 py-14">
					<div className="mx-auto max-w-3xl px-4 sm:px-6">
						<h2 className="mb-8 text-center text-xl font-semibold sm:text-3xl">
							Câu Hỏi Thường Gặp Về Rượu Vang Đỏ
						</h2>
