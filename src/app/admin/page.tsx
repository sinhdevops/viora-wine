	...
	if (loading) {
		return (
			<div className="flex min-h-screen items-center justify-center">
				<Loader2 size={32} className="animate-spin text-[#C80000]" />
			</div>
		);
	}
			...
			<div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between md:mb-8">
				<div>
					<div className="mb-1 flex items-center gap-2">
						<Wine size={20} className="text-[#C80000]" />
						<span className="text-xs font-bold uppercase tracking-widest text-[#C80000]">Viora Wine</span>
					</div>
				...
				<div className="flex items-center gap-2 rounded-2xl border border-gray-100 bg-white px-4 py-3 shadow-sm">
					...
					<span className="text-sm font-semibold text-gray-700">
						Tổng giá trị kho:{" "}
						<span className="text-[#C80000]">{formatPrice(totalStockValue)}</span>
					</span>
				</div>
			</div>
			...
			<div className="grid grid-cols-1 gap-4 md:gap-6 lg:grid-cols-3">
				...
				<div className="space-y-6 lg:col-span-2">
					...
					<div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
						<div className="mb-5 flex items-center justify-between">
							<div className="flex items-center gap-2">
								<BarChart3 size={18} className="text-[#C80000]" />
					...
					<div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
						<div className="mb-5 flex items-center justify-between">
							<div className="flex items-center gap-2">
								<ShoppingBag size={18} className="text-[#C80000]" />
								<h2 className="font-bold text-gray-900">Sản phẩm gần đây</h2>
							</div>
							<Link
								href="/admin/products"
								className="flex items-center gap-1 text-xs font-semibold text-[#C80000] hover:underline"
							>
				...
				<div className="space-y-6">
					...
					<div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
						<div className="mb-5 flex items-center gap-2">
							<Layers size={18} className="text-[#C80000]" />
						...
						<div className="mt-4 rounded-xl bg-gray-50 p-3">
							...
							<p className="mt-0.5 text-lg font-extrabold text-[#C80000]">{formatPrice(totalStockValue)}</p>
						</div>
					</div>
					...
					<div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
						<div className="mb-5 flex items-center justify-between">
							<div className="flex items-center gap-2">
								<CalendarDays size={18} className="text-[#C80000]" />
